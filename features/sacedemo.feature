...
Scenario: Testing the checkout information when blank
    ...
    Then error "Error: First Name is required" is shown
...
Scenario: Testing the checkout information when last name and zip code are blank
    ...
    When I click on the "Continue" button 
    Then error "Error: Last Name is required" is shown
...
Scenario Outline: Testing the checkout information when there's blanks
    ...
    And I click on the cart icon 
    And click on the "checkout" button.
    And enter "<first_name>" in the First Name field
    And enter "<last_name>" in the Last Name field
    And enter <zipcode> in the Postal Code
    When I click on the "Continue" button 
    Then error "<Error: Postal Code is required>" is shown
